        ...
        -->
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li>
                        <a href="{{ route('administracion_home') }}"><i class="fa fa-fw fa-dashboard"></i> Home</a>
                    </li>
                    <li>
                        <a href="{{ route("usuarios.index") }}"><i class="fa fa-fw fa-user"></i> Usuarios</a>
                    </li>
                    <li>
                        <a href="{{ route("exams.index") }}"><i class="fa fa-fw fa-pencil"></i> @lang('administracion.exams')</a>
                    </li>
                    <li>
